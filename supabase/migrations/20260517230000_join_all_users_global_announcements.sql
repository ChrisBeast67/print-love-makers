-- Ensure ALL users are joined to global announcements
BEGIN;

-- Make sure global announcements chat exists
...
-- Add ALL users (who aren't already members) to global announcements
